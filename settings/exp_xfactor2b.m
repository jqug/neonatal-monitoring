...
%%%%%%    Experiment settings     %%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
settings.expid = 'xfactor2b';
settings.shortdesc = 'X-factor 2(b): Bradycardia factor introduced.';
...
%5 bradycardia
%6 x 
settings.factors_to_use = [6 5] ;  % x-factor always goes first if present, brady goes before handling
