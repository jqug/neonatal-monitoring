...
%%%%%%    Experiment settings     %%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
settings.expid = 'xfactor2a';
settings.shortdesc = 'X-factor 2(a): Bradycardia picked up by X-factor.';
settings.train.babies = 1:5; %6:10;% :15;
...
settings.test.startindex = 74200; 
settings.test.nsamples = 1500; 
...
settings.evaluate.use_all_annotations_for_xfactor = 0;
...
%5 bradycardia
%6 x 
settings.factors_to_use = [6] ;  % x-factor always goes first if present, brady goes before handling
