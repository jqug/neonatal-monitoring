...
%%%%%%    Experiment settings     %%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
settings.expid = 'knownfactors';
settings.shortdesc = 'Known factors: Detection of blood sample and periods of bradycardia.';
settings.train.babies = 1:5; settings.train.xfactor.use_em = 0;
settings.train.xfactor.num_em_updates = 2;
settings.train.xfactor.initial_xi = 1.2;
settings.test.babies = 12;
settings.test.onlyusefirstfewsamples = 1;
settings.test.startindex = 68500; 
settings.test.nsamples = 69430-68500;
...
%5 bradycardia
%6 x 
settings.factors_to_use = [5 1] ;  % x-factor always goes first if present, brady goes before handling
