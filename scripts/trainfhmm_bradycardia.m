bradys = getdatabetweenintervals(data.preprocessed,intervals.Bradycardia,obschannels,settings.train.babies);

% get the mean and diagonal covariance of training data
alltrainingdata =cellconcat(bradys);
...
fhmm_trans = markovtransitionprobsfromintervals(intervals.Bradycardia,settings.train.babies);
...
fhmm_factor = {fhmm_mu fhmm_cov settings.factors.bradycardia.ydims fhmm_prior};
