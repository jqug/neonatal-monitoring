...
alltrainingdata =cellconcat(bloodsamples);
...
fhmm_trans = markovtransitionprobsfromintervals(intervals.BloodSample,settings.train.babies);
...
fhmm_factor = {fhmm_mu fhmm_cov settings.factors.bloodsample.ydims fhmm_prior};
